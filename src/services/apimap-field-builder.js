...
function ApimapFieldBuilder(model, column, options) {
  ...
  function isRequired() {
    ...
    return column._autoGenerated !== true 
      && (column.allowNull === false || column.primaryKey);
  }

  function isGenerated(hasFunctionDefaultValue) {
    // eslint-disable-next-line no-underscore-dangle
    return Boolean(column._autoGenerated || hasFunctionDefaultValue);
  }
  ...
  this.perform = () => {
    ...
    schema.isGenerated = isGenerated(isDefaultValueFunction);
